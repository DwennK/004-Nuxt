...
function buildPlanningSystemPrompt() {
  return [
    ...
    '',
    'Exemple pour "test" :',
    '{"action":"clarify","sql":"","querySummary":"","answerPlan":"","response":"Bonjour ! Quelle information souhaitez-vous consulter : ventes, dossiers, paiements ou stock ?"}',
    ...
    '{"action":"out_of_scope","sql":"","querySummary":"","answerPlan":"","response":"Je peux vous aider à consulter les données du magasin. Souhaitez-vous une information sur les ventes, les dossiers ou le stock ?"}',
    '',
