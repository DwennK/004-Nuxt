...
<template>
  ...
  >
    <UPageCard
      title="Profil"
      description="Ces informations peuvent être affichées sur les documents et communications."
      variant="naked"
    ...
    <UPageCard variant="subtle">
      ...
      <UFormField
        name="username"
        label="Identifiant"
        description="Identifiant unique pour la connexion et l’URL de profil."
        required
        class="flex max-sm:flex-col justify-between items-start gap-4"
      >
        <UInput
      ...
      <UFormField
        name="bio"
        label="Bio"
        description="Brève description du profil. Les URLs sont détectées automatiquement."
        class="flex max-sm:flex-col justify-between items-start gap-4"
        :ui="{ container: 'w-full' }"
      >
        <UTextarea
